...
int main()
{
	...
	auto buffer_A = cuda_::memory::managed::make_unique_span<float>(numElements);
	auto buffer_B = cuda_::memory::managed::make_unique_span<float>(numElements);
	auto buffer_C = cuda_::memory::managed::make_unique_span<float>(numElements);
