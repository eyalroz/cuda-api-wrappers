...
#ifndef CUDA_API_WRAPPERS_NVML_DEVICE_QUERIES_HPP_
#define CUDA_API_WRAPPERS_NVML_DEVICE_QUERIES_HPP_
...
unsigned int ApplicationsClock (device_t device, nvmlClockType_t clockType ); // REDO ME
...
#endif // CUDA_API_WRAPPERS_NVML_DEVICE_QUERIES_HPP_