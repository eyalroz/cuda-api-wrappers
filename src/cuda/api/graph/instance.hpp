...
constexpr inline bool operator==(const update_status_t &lhs, const named_t &rhs) noexcept { return lhs == (update_status_t) rhs; }
constexpr inline bool operator!=(const update_status_t &lhs, const named_t &rhs) noexcept { return lhs != (update_status_t) rhs; }
constexpr inline bool operator==(const named_t &lhs, const update_status_t &rhs) noexcept { return (update_status_t) lhs == rhs; }
constexpr inline bool operator!=(const named_t &lhs, const update_status_t &rhs) noexcept { return (update_status_t) lhs != rhs; }
