 ...
 * @file
 *
 * @brief A memory region class (@ref cuda::memory::region_t and @ref cuda::memory::const_region_t) and related
 * functionality.
 */
...
/**
 * An untyped, but sized, region with const-constained data in some memory space
 */
